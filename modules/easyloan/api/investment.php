...
// get investment
$query = "SELECT inv_title, inv_category, inv_usr_id, inv_interest_rate, inv_repayment_method, inv_amount, inv_duration, inv_is_done, inv_created, inv_start, inv_end, inv_minimum, inv_step, inv_investment, inv_purpose, inv_asset_description FROM investments_inv WHERE inv_app_id = ".strval($id);
