...
{
  watchdog('easyloan - api', 'api called');
  if (is_null($id) || $id <= 0)
  {
    return false;
  }
  ...
  switch ($type)
  {
    case 1: // register
      ...
      watchdog('easyloan - api', 'name pass: ' . $namepass);
