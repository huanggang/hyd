...
function initialize_user($id)
{
  ...
  $flag = $flag && (mysqli_query($con, "INSERT IGNORE INTO account_withdraw_act_wth (act_wth_usr_id, act_wth_amount, act_wth_fee, act_wth_bnk_times, act_wth_updated) VALUES (".strval($id).", 0, 0, 0, '".$nowStr."')") != false);
