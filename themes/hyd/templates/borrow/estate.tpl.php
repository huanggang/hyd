...
drupal_add_css(drupal_get_path('theme','hyd') . '/css/prod.css');
?>
      ...
      <div class="info-list">
        ...
        <div class="info-list-condition border-bt">
          ...
          <div class="review-button"> 
            <a href="<?php if($user->uid > 0) print "estate/apply"; else print "/user/login"; ?>" class="ui-button ui-button-blue ui-button-mid">立即申请</a> 
          </div> 
        </div>
        ...
        <div class="info-list-fee border-bt">
          ...
          <ul class="ui-list-disc">
            <li>
              <dl>
                <dt><i></i>成交服务费</dt>
                <dd>用户成功借款后按照评定的信用等级会一次性的从所得借款中扣除一定的比例（0%-5%）作为成交服务费，该服务费将进入好易贷平台的风险备用金账户，专项用于好易贷的本金保障计划。</dd>
              </dl>
            </li>
            <li>
              <dl>
                <dt><i></i>账户管理费</dt>
                <dd>好易贷将按照借款人的借款期限，每月向借款人收取其借款本金的0.3%作为借款管理费。</dd>
              </dl>
            </li>
          </ul>
        </div>
