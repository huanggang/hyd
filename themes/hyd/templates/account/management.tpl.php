...
drupal_add_css(drupal_get_path('theme','hyd') . '/css/itemlist.css');
...
drupal_add_js(drupal_get_path('theme','hyd') . '/js/jquery.simplePagination.js');
drupal_add_js(drupal_get_path('theme','hyd') . '/js/manage_users.js');
