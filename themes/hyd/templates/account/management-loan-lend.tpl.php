    ...
    <form class="ui-form" method="post" id="lendForm">
      <fieldset>
        <div class="ui-form-item mt20">
          <label class="ui-label"><span class="ui-form-required">*</span>放款日期</label>
          <input class="ui-input" type="text" value="" name="loaned" id="loaned"> (例如: 2007/03/26)
        </div>
        <div class="ui-form-item">
          <label class="ui-label"><span class="ui-form-required">*</span>借款金额</label>
        ...
        <div class="ui-form-item">
          <label class="ui-label"><span class="ui-form-required">*</span>借款日期</label>
          <input class="ui-input" type="text" value="" name="start" id="start"> (例如: 2007/03/26)
        </div>
        <div class="ui-form-item">
          <label class="ui-label"><span class="ui-form-required">*</span>还款日期</label>
